...
float LeptonIsoHelper::effective_area(int sampleType, int setup, const pat::Electron& l) {
  ...
  if (setup==2011) {
   ...
   return ElectronEffectiveArea::GetElectronEffectiveArea(ElectronEffectiveArea::kEleGammaAndNeutralHadronIso04,
